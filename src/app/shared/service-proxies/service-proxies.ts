...
export interface IOpTerminalRegistrationRequestServiceProxy {
    /**
     * @return OK
     */
    getAllOpTerminalRegistrationRequests(): Observable<OpTerminalRegistrationRequest[]>;
    /**
     * @return OK
     */
    getAllOpTerminalRegistrationRequestsPendingOnly(): Observable<OpTerminalRegistrationRequest[]>;
    /**
     * @return OK
     */
    getOpTerminalRegistrationRequestById(autoid: number): Observable<OpTerminalRegistrationRequest>;
    /**
     * @return OK
     */
    updateOpTerminalRegistrationRequest(autoid: number, body: OpTerminalRegistrationRequest): Observable<void>;
}

@Injectable()
export class OpTerminalRegistrationRequestServiceProxy implements IOpTerminalRegistrationRequestServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    getAllOpTerminalRegistrationRequests(): Observable<OpTerminalRegistrationRequest[]> {
        let url_ = this.baseUrl + "/api/OpTerminalRegistrationRequest";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllOpTerminalRegistrationRequests(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllOpTerminalRegistrationRequests(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<OpTerminalRegistrationRequest[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<OpTerminalRegistrationRequest[]>;
        }));
    }

    protected processGetAllOpTerminalRegistrationRequests(response: HttpResponseBase): Observable<OpTerminalRegistrationRequest[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(OpTerminalRegistrationRequest.fromJS(item));
            }
            else {
                result200 = null as any;
            }
     ...
     */
    getAllOpTerminalRegistrationRequestsPendingOnly(): Observable<OpTerminalRegistrationRequest[]> {
        let url_ = this.baseUrl + "/api/OpTerminalRegistrationRequest/GetPendings";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllOpTerminalRegistrationRequestsPendingOnly(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllOpTerminalRegistrationRequestsPendingOnly(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<OpTerminalRegistrationRequest[]>;
                }
            } else
    ...
    protected processGetAllOpTerminalRegistrationRequestsPendingOnly(response: HttpResponseBase): Observable<OpTerminalRegistrationRequest[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    getOpTerminalRegistrationRequestById(autoid: number): Observable<OpTerminalRegistrationRequest> {
        let url_ = this.baseUrl + "/api/OpTerminalRegistrationRequest/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetOpTerminalRegistrationRequestById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetOpTerminalRegistrationRequestById(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<OpTerminalRegistrationRequest>;
                }
            } else
    ...
    protected processGetOpTerminalRegistrationRequestById(response: HttpResponseBase): Observable<OpTerminalRegistrationRequest> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = OpTerminalRegistrationRequest.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 404) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    updateOpTerminalRegistrationRequest(autoid: number, body: OpTerminalRegistrationRequest): Observable<void> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateOpTerminalRegistrationRequest(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateOpTerminalRegistrationRequest(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processUpdateOpTerminalRegistrationRequest(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class OpTerminalRegistrationRequest implements IOpTerminalRegistrationRequest {
    autoid?: number;
    createddate?: Date;
    status?: string | undefined;
    macAddress?: string | undefined;
    ...
    constructor(data?: IOpTerminalRegistrationRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.macAddress = _data["macAddress"];
            this.pcName = _data["pcName"];
            this.acceptanceStatus = _data["acceptanceStatus"];
        }
    }

    static fromJS(data: any): OpTerminalRegistrationRequest {
        data = typeof data === 'object' ? data : {};
        let result = new OpTerminalRegistrationRequest();
        result.init(data);
        return result;
    }
...
export interface IOpTerminalRegistrationRequest {
    autoid?: number;
    createddate?: Date;
    status?: string | undefined;
    macAddress?: string | undefined;
