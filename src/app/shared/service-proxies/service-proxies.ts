...
export interface IAclAdminUserServiceProxy {
    /**
     * @return OK
     */
    getAllAclAdminUsers(): Observable<AclAdminUser[]>;
    /**
     * @return OK
     */
    getAclAdminUserById(autoid: number): Observable<AclAdminUser>;
    /**
     * @return OK
     */
    updateAclAdminUser(autoid: number, body: AclAdminUser): Observable<void>;
    /**
     * @return OK
     */
    createAclAdminUser(body: AclAdminUser): Observable<void>;
    /**
     * @return OK
     */
    deleteAclAdminUser(autoid: number): Observable<void>;
}

@Injectable()
export class AclAdminUserServiceProxy implements IAclAdminUserServiceProxy {
     ...
     */
    getAllAclAdminUsers(): Observable<AclAdminUser[]> {
        let url_ = this.baseUrl + "/api/AclAdminUser/GetAllAclAdminUsers";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllAclAdminUsers(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllAclAdminUsers(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<AclAdminUser[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<AclAdminUser[]>;
        }));
    }

    protected processGetAllAclAdminUsers(response: HttpResponseBase): Observable<AclAdminUser[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(AclAdminUser.fromJS(item));
            }
            else {
     ...
     */
    getAclAdminUserById(autoid: number): Observable<AclAdminUser> {
        let url_ = this.baseUrl + "/api/AclAdminUser/GetAclAdminUserById/{id}?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAclAdminUserById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAclAdminUserById(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<AclAdminUser>;
                }
            } else
    ...
    protected processGetAclAdminUserById(response: HttpResponseBase): Observable<AclAdminUser> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AclAdminUser.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 404) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     */
    updateAclAdminUser(autoid: number, body: AclAdminUser): Observable<void> {
        let url_ = this.baseUrl + "/api/AclAdminUser/UpdateAclAdminUser/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateAclAdminUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateAclAdminUser(response_ as any);
                } catch (e) {
    ...
    protected processUpdateAclAdminUser(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    createAclAdminUser(body: AclAdminUser): Observable<void> {
        let url_ = this.baseUrl + "/api/AclAdminUser/CreateAclAdminUser";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateAclAdminUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateAclAdminUser(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processCreateAclAdminUser(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            result201 = AclAdminUser.fromJS(resultData201);
     ...
     */
    deleteAclAdminUser(autoid: number): Observable<void> {
        let url_ = this.baseUrl + "/api/AclAdminUser/DeleteAclAdminUser/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteAclAdminUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteAclAdminUser(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processDeleteAclAdminUser(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AclTerminalServiceProxy implements IAclTerminalServiceProxy {
     ...
     */
    getAllAclTerminals(): Observable<AclTerminal[]> {
        let url_ = this.baseUrl + "/api/AclTerminal/GetAllAclTerminals";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    getAclTerminalById(autoid: number): Observable<AclTerminal> {
        let url_ = this.baseUrl + "/api/AclTerminal/GetAclTerminalById/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
     ...
     */
    updateAclTerminal(autoid: number, body: AclTerminal): Observable<void> {
        let url_ = this.baseUrl + "/api/AclTerminal/UpdateAclTerminal/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
     ...
     */
    createAclTerminal(body: AclTerminal): Observable<void> {
        let url_ = this.baseUrl + "/api/AclTerminal/CreateAclTerminal";
        url_ = url_.replace(/[?&]$/, "");
...
export class OpServiceServiceProxy implements IOpServiceServiceProxy {
     ...
     */
    getAllOpServices(): Observable<OpService[]> {
        let url_ = this.baseUrl + "/api/OpService/GetAllOpServices";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    getOpServiceById(autoid: number): Observable<OpService> {
        let url_ = this.baseUrl + "/api/OpService/GetOpServiceById/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
     ...
     */
    updateOpService(autoid: number, body: OpService): Observable<void> {
        let url_ = this.baseUrl + "/api/OpService/UpdateOpService/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
     ...
     */
    createOpService(body: OpService): Observable<void> {
        let url_ = this.baseUrl + "/api/OpService/CreateOpService";
        url_ = url_.replace(/[?&]$/, "");
...
export class OpSiteServiceProxy implements IOpSiteServiceProxy {
     ...
     */
    getAllOpSites(): Observable<OpSite[]> {
        let url_ = this.baseUrl + "/api/OpSite/GetAllOpSites";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    getOpSiteById(autoid: number): Observable<OpSite> {
        let url_ = this.baseUrl + "/api/OpSite/GetOpSiteById/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
     ...
     */
    updateOpSite(autoid: number, body: OpSite): Observable<void> {
        let url_ = this.baseUrl + "/api/OpSite/UpdateOpSite/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
     ...
     */
    createOpSite(body: OpSite): Observable<void> {
        let url_ = this.baseUrl + "/api/OpSite/CreateOpSite";
        url_ = url_.replace(/[?&]$/, "");
...
export class OpVehicleTypeServiceProxy implements IOpVehicleTypeServiceProxy {
     ...
     */
    getAllOpVehicleTypes(): Observable<OpVehicleType[]> {
        let url_ = this.baseUrl + "/api/OpVehicleType/GetAllOpVehicleTypes";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    getOpVehicleTypeById(autoid: number): Observable<OpVehicleType> {
        let url_ = this.baseUrl + "/api/OpVehicleType/GetOpVehicleTypeById/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
     ...
     */
    updateOpVehicleType(autoid: number, body: OpVehicleType): Observable<void> {
        let url_ = this.baseUrl + "/api/OpVehicleType/UpdateOpVehicleType/{id}?";
        if (autoid === undefined || autoid === null)
            throw new globalThis.Error("The parameter 'autoid' must be defined and cannot be null.");
        else
            url_ += "autoid=" + encodeURIComponent("" + autoid) + "&";
     ...
     */
    createOpVehicleType(body: OpVehicleType): Observable<void> {
        let url_ = this.baseUrl + "/api/OpVehicleType/CreateOpVehicleType";
        url_ = url_.replace(/[?&]$/, "");
